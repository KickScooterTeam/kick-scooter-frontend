...
function CardMenu({cardInfo, handleDeleteCard}) {
    ...
    const handleSetDefaultCard = e => {
        ...
        console.log(payload);
        axios.put(API_BASE_URL + `payment-service/cards/default`, payload).then((res) => {
            console.log(payload);
            if (res.status === 200) {
                setAnchorEl(null);
...
function Cards() {
    ...
    const handleDeleteCard = cardInfo => {
        return e => {
            ...
            axios.delete(API_BASE_URL + `payment-service/cards`, {data: payload}).then((res) => {
                console.log(payload);
                if (res.status === 200) {
                    getCards();
                    console.log(res.data);
    ...
    const getCards = () => {
        ...
        axios.get(API_BASE_URL + `payment-service/cards/` + token)
            .then((res) => {
                if (res.status === 200) {
                    setCards(res.data);
                    console.log(cards);
...
function NewCardTemplate() {
    ...
    const handleAddCard = e => {
        ...
        console.log(payload);
        axios.post(API_BASE_URL + `payment-service/cards`, payload).then((res) => {
            console.log(payload);
            if (res.status === 200) {
                console.log(res.data);
                setOpen(false);
